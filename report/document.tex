...
<<<<<<< Updated upstream
=======
	Onsager solved the 2D Ising model for the case of $h = 0$ in 1944\cite{Onsager1944},
	...
	The results we are listing below are obtained from the Onsager solution\cite{Onsager1944}.
